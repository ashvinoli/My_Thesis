...
%code is for model number 15 fixed straight edge
clear, clc
syms alp phi x
chord = 5;
a=0.715; %radius of cylinder
l=2.560; %length of cylinder
h=0.0625; %thickness of cylinder
nu=0.33; %poisson's ratio
csq=h^2/(12*a^2); %a parameter
E=72450000000; %modulus of elasticity
p=25600; %udl in gravity direction
...
dwp=diff(wi,phi);
eqn4=subs(ui,phi,ang/2)==0;
eqn5=subs(vi,phi,ang/2)==0;
eqn6=subs(wi,phi,ang/2)==0;
eqn7=subs(dwp,phi,ang/2)==0;
